...
Public Class Admit
    ...
    Private Function performQueryStatement() As String
        ...
        ElseIf Not DateIn1Txt.Text = "" And DateOut1Txt.Text = "" Then
            var_date = Format(Date.Today(), "dd-MM-yyyy")
            'MessageBox.Show(var_date)
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("Token No. - " & RoomTypeTxt.Text & "", ReportBodyFont, Brushes.Chocolate, 100, 250)
        e.Graphics.DrawString("Room No. - " & RoomNoTxt.Text & "", ReportBodyFont, Brushes.Chocolate, 100, 300)
