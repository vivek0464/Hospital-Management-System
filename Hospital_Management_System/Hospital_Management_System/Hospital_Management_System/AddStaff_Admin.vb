...
Public Class AddStaff_Admin
    ...
    Private Sub RegisterBtn_Click(sender As Object, e As EventArgs) Handles RegisterBtn.Click
        ...
        query = "Insert Into [Staff] ([Name],[Designation],[Gender],[Mobile],[Address],[Work Shift],[Username],[Password]) Values (?,?,?,?,?,?,?,?)"
        ...
        Try
            ...
            'cmd.Parameters.Add(New OleDbParameter("Date Of Birth", AgeTxt.Text))
    ...
    Private Function Send_Mail() As Boolean
        Try
            ...
            e_mail.Subject = "Your Username is : " & username & " and Password is : " & password & ". Remember your login credentials for future use"
