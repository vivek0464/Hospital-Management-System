...
Public Class SearchDonor_Admin
    ...
    Private Sub UpdateBtn_Click(sender As Object, e As EventArgs) Handles UpdateBtn.Click
        ...
        Dim cmd As New OleDbCommand
        Dim query As String
        query = "Update [Donor] Set [Name] = '" & NameTxt.Text & "', [Mobile] = '" & MobileTxt.Text & "', [Age] = " & DOBTxt.Text & ", [Gender] = '" & GenderTxt.Text & "', [Blood] = '" & BloodGroupTxt.Text & "' Where [ID] = " & IDTxt.Text & ";"
        myconnection.Open()
        Try
    ...
    Private Sub DeleteBtn_Click(sender As Object, e As EventArgs) Handles DeleteBtn.Click
        ...
        query = "Delete From [Donor] Where [ID] = " & IDTxt.Text & ";"
        'Open the connection
        myconnection.Open()
        Try
            cmd = New OleDbCommand(query, myconnection)
    ...
    Private Sub SearchResultGrid_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles SearchResultGrid.CellMouseClick
        ...
        QuantityTxt.Text = SearchResultGrid.Rows(e.RowIndex).Cells(8).Value
