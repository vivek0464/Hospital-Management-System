...
Public Class SearchReciever_Admin
    ...
    Private Sub SearchBtn_Click(sender As Object, e As EventArgs) Handles SearchBtn.Click
        ...
        Dim query As String
        'query statement
        query = "Select * From [Recievers] Where [Name] Like '%" & NameSTxt.Text.ToLower & "%' And [Mobile] Like '%" & MobileSTxt.Text & "%';"
    ...
    Private Sub UpdateBtn_Click(sender As Object, e As EventArgs) Handles UpdateBtn.Click
        If NameTxt.Text = "" Or MobileTxt.Text = "" Or GenderTxt.Text = "" Or DOBTxt.Text = "" Or BloodGroupTxt.Text = "" Then
            ...
            Exit Sub
        End If
        If Not (Form1.Name_Validation(NameTxt.Text.ToLower) And Form1.Mobile_Validator(MobileTxt.Text)) Then
            MessageBox.Show("Invalid Credentitals")
            Exit Sub
        End If
        Dim cmd As New OleDbCommand
        Dim query As String
        query = "Update [Recievers] Set [Name] = '" & NameTxt.Text & "', [Mobile] = '" & MobileTxt.Text & "', [Age] = " & DOBTxt.Text & ", [Gender] = '" & GenderTxt.Text & "', [Blood] = '" & BloodGroupTxt.Text & "' Where [ID] = " & IDTxt.Text & ";"
        myconnection.Open()
        Try
    ...
    Private Sub SearchResultGrid_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles SearchResultGrid.CellMouseClick
        ...
        DateRecievedTxt.Text = SearchResultGrid.Rows(e.RowIndex).Cells(6).Value
    ...
    Private Function UpdateTable() As Boolean
        ...
        Dim query As String
        'query statement
        query = "Select * From [Recievers] Where [Name] Like '%" & NameSTxt.Text.ToLower & "%' And [Mobile] Like '%" & MobileTxt.Text & "%';"
        'Create New DataTable
        dt = New DataTable()
        'Open the connection
        myconnection.Open()
