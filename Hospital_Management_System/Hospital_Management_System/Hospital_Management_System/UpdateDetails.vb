...
Public Class UpdateDetails
    ...
    Private Sub UpdateBtn_Click(sender As Object, e As EventArgs) Handles UpdateBtn.Click
        Dim str As String
        str = "Update [Patient] set [Mobile]='" & MobileTxt.Text & "',[Age]='" & AgeTxt.Text & "',[Address]='" & AddressTxt.Text & "'where [PID] = " & PIDTxt.Text & " "
        If Not Form1.Mobile_Validator(MobileTxt.Text.ToLower) Then
            MessageBox.Show("Enter Valid Phone number")
            Exit Sub
        ElseIf Not Form1.age_validator(AgeTxt.Text.ToLower) Then
    ...
    Private Sub DataGridView1_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles SearchResultGrid.CellMouseClick
        ...
        Try
            ...
            AgeTxt.Text = row.Cells(2).Value.ToString
